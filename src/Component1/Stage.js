            ...
            <div className="container">
                <div className="stagebox">
                    <div className="winner">
                        ...
                        <div className="name" style={{color:"#8F5206"}}>Subham</div>
                    ...
                    <div className="winner">
                        ...
                        <div className="name" style={{color:"#8F5206"}}>Shivam</div>
                    ...
                    <div className="winner">
                        ...
                        <div className="name" style={{color:"#8F5206"}}>Subrato</div>
                ...
                <div className="runnerup">
                    <div className="fourfive">
                        ...
                        <div className="details">
                            <span className="runner-up-name" style={{color:"#a7a49d"}}>Winner 4</span>
                        </div>
                    ...
                    <div className="fourfive"> <div className="position">
                        ...
                        <div className="details">
                            <span className="runner-up-name" style={{color:"#a7a49d"}}>Winner 5</span>
                        </div>
